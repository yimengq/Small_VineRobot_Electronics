...
#define FLOW_CONTROL_QUEUE_LENGTH (500) //originally 200 - 8.8.2025
...
static esp_err_t pkt_wifi2eth(void *buffer, uint16_t len, void *eb) //### look at this function, how does it allocate memory
{
...
static esp_err_t pkt_eth2wifi(esp_eth_handle_t eth_handle, uint64_t *buffer, uint32_t len, void *priv) //## buffer type originally of type "uint8_t"
{
