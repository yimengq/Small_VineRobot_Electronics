...
def read_bno():
    ...
    while True:
        ...
        with bno_changed:
            ...
            bno_data["acceleration"] = bno.acceleration  # acceleration in m/s^2
            bno_data["gyroscope"] = bno.gyro  # angular velocity in rad/s
...
def bno_sse():
    ...
    while True:
        ...
        with bno_changed:
            ...
            # Grab accelerometer and gyroscope data
            accel_x, accel_y, accel_z = bno_data["acceleration"]
            gyro_x, gyro_y, gyro_z = bno_data["gyroscope"]
