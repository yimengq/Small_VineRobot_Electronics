...
def main():
    ...
    ap.add_argument("--addr2", type=lambda x: int(x, 0), default=0x35, help="Motor2 DRV8234 addr")

    ap.add_argument("--dac1-addr", type=lambda x: int(x, 0), default=0x63, help="DAC1 addr (motor1 VREF)")
    ap.add_argument("--dac2-addr", type=lambda x: int(x, 0), default=0x64, help="DAC2 addr (motor2 VREF)")
