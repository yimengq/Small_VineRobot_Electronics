...
# --- Pin mapping (Radxa Zero3: A6=CLK, A7=DIN) ---
CHIP_NAME = "gpiochip3"   # adjust for your board
PIN_CLK   = 6             # A6
PIN_DIN   = 7             # A7
...
def pulse_clk():
    clk.set_value(1); time.sleep(0.000001)
    clk.set_value(0); time.sleep(0.000001)
...
try:
    ...
    clk.release(); din.release(); chip.close()
