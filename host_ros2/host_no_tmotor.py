...
# ------------------ Config ------------------
# Stable serial path (pressure UART). If you don't need pressure control,
# you can leave the UART closed (the open call is commented out below).
...
# or even (0.5, 10.0) while debugging
